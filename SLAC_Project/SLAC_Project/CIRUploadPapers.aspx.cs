...
{
    public partial class CIRUploadPapers : System.Web.UI.Page
    {
        ...
        public void UploadFile()
        {
            ...
            if (contenttype != String.Empty)
            {
                ...
                string query = "INSERT INTO UPLOADS2 VALUES(@COMPANYPAPER,@NAME,@CONTENT,@DATA)";
                SqlCommand cmd = new SqlCommand(query);
                cmd.Parameters.AddWithValue("@COMPANYPAPER", txt_coursecode.Text);
