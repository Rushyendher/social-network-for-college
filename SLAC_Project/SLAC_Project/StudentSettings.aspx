<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentSettings.aspx.cs" Inherits="SLAC_Project.StudentSettings" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="settings">
            ...
            <asp:TextBox ID="TextBox3" runat="server" placeholder="Your quote here"></asp:TextBox><br />
